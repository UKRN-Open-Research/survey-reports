...
# Functions
source("functions/function_format_leadership.R")         # Format leadership
source("functions/function_plots.R")                     # Generate plots
source("functions/function_format_priority.R")           # Format OR area priority responses
source("functions/function_format_priority_training.R")  # Format OR area priority responses (subset)
source("functions/function_format_training.R")           # Format training responses for graph
