...
if(choose == "all"){
  ...
  # Number of responses text
  cat('This report summarises', nrow(dat), 'survey responses from life and health sciences researchers at The University of Bristol.h2>Survey dissemination</h2>\nUniversity of Bristol researchers were reached via department heads.\n\n')
  # Plot
