...
Most responses came from MRC-funded institutes and researchers in the health sciences domain (Fig 2a). Additionally, most survey respondents did not have a major leadership role.
...
Most respondents would find training in data sharing useful (Fig 3). Additionally, the majority of survey respondents were familiar or already engaged in open access and data sharing practices, however a large proportion were not familiar with open code and preregistration.
