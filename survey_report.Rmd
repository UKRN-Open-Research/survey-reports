...
# Survey Data
<!-- fix figure caption -->
<!-- fix numbers - may be caused by factor levels? -->
...
if(choose == "all"){
  ...
  # Plot caption
  cat('\n\nFigure 1: Breakdown of survey responses by organisation and research discipline (a) and number of respondents with a major leadership role (b). A major leadership role was defined as running a group/lab, directing a school/organisation, or similar.\n\n')
} else if(choose == "mrc"){
  # Number of responses text
  ...
  # Plot caption
  cat('\n\nFigure 1: Breakdown of survey responses from researchers with a major leadership role. A major leadership role was defined as running a group/lab, directing a school/organisation, or similar.\n\n')
} else if(choose == "babraham"){
  # Number of responses text
